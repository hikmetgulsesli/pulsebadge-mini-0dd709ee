...
- PulseBadge Mini turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny single-page utility called PulseBadge Mini. It should show three service badges, toggle each badge between ok/warn/down, persist state in localStorage, expose window.app state/actions, and export a JSON snapshot. Keep it static HTML/CSS/JS only.
...
- Record Operations - PulseBadge Mini
- Record Editor - PulseBadge Mini
- Insights - PulseBadge Mini

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - PulseBadge Mini
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - PulseBadge Mini
...
SCREEN_SPEC_3:
- exact_screen_title: Insights - PulseBadge Mini
